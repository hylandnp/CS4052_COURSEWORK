...
SceneNodeTransform::SceneNodeTransform(const std::string& p_name,
	...
	m_location_values(0.f),
	m_rotation_values(0.f),
	m_scale_values(1.f),
...
{
	m_location_values.x += p_offset_x;
	m_rebuild_matrices = true;
}
...
{
	m_location_values.y += p_offset_y;
	m_rebuild_matrices = true;
}
...
{
	m_location_values.z += p_offset_z;
	m_rebuild_matrices = true;
}
...
{
	m_rotation_values.y = p_new_y;
	m_rebuild_matrices = true;
}

void SceneNodeTransform::setRotationZ(float p_new_z)
{
	m_rotation_values.z = p_new_z;
	m_rebuild_matrices = true;
}
...
{
	m_rotation_values.x += p_offset_x;
	m_rebuild_matrices = true;
}
...
{
	m_rotation_values.y += p_offset_y;
	m_rebuild_matrices = true;
}
...
{
	m_rotation_values.z += p_offset_z;
	m_rebuild_matrices = true;
}
...
{
	m_scale_values = glm::vec3(p_uniform_scale);
	m_rebuild_matrices = true;
}
...
{
	m_scale_values += p_uniform_offset;
	m_rebuild_matrices = true;
}
...
{
	// Translation:
	m_cached_local_matrix = glm::translate(glm::mat4(1.f), m_location_values);

	// Rotation:
	m_cached_local_matrix *= glm::toMat4(glm::quat(glm::radians(m_rotation_values)));

	/*m_cached_local_matrix = glm::rotate(m_cached_local_matrix,
										glm::radians(m_rotation_values.x),
										glm::vec3(1.f, 0.f, 0.f));
	m_cached_local_matrix = glm::rotate(m_cached_local_matrix,
										glm::radians(m_rotation_values.y),
										glm::vec3(0.f, 1.f, 0.f));
	m_cached_local_matrix = glm::rotate(m_cached_local_matrix,
										glm::radians(m_rotation_values.z),
										glm::vec3(0.f, 0.f, 1.f));*/

	// Scaling:
	m_cached_local_matrix = glm::scale(m_cached_local_matrix, m_scale_values);
