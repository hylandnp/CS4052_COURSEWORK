...
GLSL fragment shader implementing Phong lighting model.
...
void main()
{
	...
	//frag_colour = vec4(specular_intensity + diffuse_intensity + ambient_intensity, 1.0);
}